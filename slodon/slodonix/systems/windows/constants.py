...
KEYEVENTF_KEYDOWN = 0x0000 # keydown event, specifies the key that has been pressed down.
...
MOUSEEVENTF_LEFTCLICK = MOUSEEVENTF_LEFTDOWN + MOUSEEVENTF_LEFTUP # left mouse button click (down then up = full click)
MOUSEEVENTF_RIGHTDOWN = 0x0008 # right mouse button down 
MOUSEEVENTF_RIGHTUP = 0x0010 # right mouse button up
MOUSEEVENTF_RIGHTCLICK = MOUSEEVENTF_RIGHTDOWN + MOUSEEVENTF_RIGHTUP # right mouse button click (down then up = full click)
MOUSEEVENTF_MIDDLEDOWN = 0x0020 # middle mouse button down
MOUSEEVENTF_MIDDLEUP = 0x0040 # middle mouse button up
MOUSEEVENTF_MIDDLECLICK = MOUSEEVENTF_MIDDLEDOWN + MOUSEEVENTF_MIDDLEUP # middle mouse button click (down then up = full click)
...
FAILSAFE_POINTS = [
    (0, 0) # Moving the mouse to 0,0 in case of emergency, this will prevent the mouse from moving further, or stuck in a loop.
